        ...
        <Box
            ...
            <Container
                ...
                <Stack direction={'row'} spacing={6}>
                    <SocialButton label={'Github'} href={'https://github.com/LakshayD02'}>
                        <FaGithub />
                    </SocialButton>
                    <SocialButton label={'Snapchat'} href={'https://in.linkedin.com/in/lakshay-dhoundiyal-531b25259'}>
                        <FaLinkedin />
                    </SocialButton>
                    <SocialButton label={'Instagram'} href={'https://instagram.com/_laddu.02_'}>
                        <FaInstagram />
                    </SocialButton>
                </Stack>
            </Container>
